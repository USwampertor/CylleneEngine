...
struct CY_UTILITY_EXPORT DLLLoader {
 public:
   ...
   *	@param  Stringview path the path of the DLL
   *	@param  Stringview functionName the name of the symbol
   ...
   */
  static void*
  load(Stringview str, Stringview functionName = String("create"), bool isOSDll = true);
